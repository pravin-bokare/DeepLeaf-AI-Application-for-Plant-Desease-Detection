...
def train_test_validation_split(ds, train_split=0.8, validation_split=0.2, shuffle=False, shuffle_size=1000):
    ds_size = len(ds)
    if shuffle:
...
model.save(f'F:\Data Science\Plant Disease Identification\models/{model_version}')
